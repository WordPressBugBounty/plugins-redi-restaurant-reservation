...
(function (factory) {
  ...
  var factoryOutput = (() => {
    ...
    var x = (l, t) => {
        for (var e in t) _(l, e, { get: t[e], enumerable: !0 });
      },
      P = (l, t, e, i) => {
        if ((t && typeof t == 'object') || typeof t == 'function')
          for (let n of S(t))
            !M.call(l, n) &&
              ...
              _(l, n, {
                get: () => t[n],
                enumerable: !(i = N(t, n)) || i.enumerable,
              });
        return l;
      };
    var H = (l) => P(_({}, '__esModule', { value: !0 }), l);
    var B = {};
    x(B, { Iti: () => b, default: () => F });
    var I = [
        ['af', '93'],
      ...
      b = class {
        ...
        _f() {
          ...
          t && (c += ' iti--allow-dropdown'),
            i && (c += ' iti--show-flags'),
            n && (c += ` ${n}`),
            u || (c += ' iti--inline-dropdown');
          let p = h('div', { class: c });
          if ((this.a.parentNode?.insertBefore(p, this.a), t || i)) {
            (this.k = h('div', { class: 'iti__country-container' }, p)),
                ...
                if (
                  ...
                  if (t) {
                    let o = this.a.selectionStart === 0 && s.key === '+',
                      ...
                      u = o || a,
                      d = this._6(),
                      c = r.utils.getCoreNumber(d, this.s.iso2),
                      p =
                        this.maxCoreNumberLength &&
                        c.length >= this.maxCoreNumberLength;
                    (!u || p) && s.preventDefault();
                  }
                }
              }),
        ...
        _p3(t, e = !1) {
          ...
          for (let s = 0; s < this.p.length; s++) {
            let o = this.p[s],
              a = D(o.name),
              u = `+${o.dialCode}`;
            if (e || a.includes(n) || u.includes(n) || o.iso2.includes(n)) {
        ...
        _v(t) {
          ...
          if (o) {
            let d = this.q[f(o)],
              c = d.indexOf(this.s.iso2) !== -1 && a.length <= o.length - 1;
            if (!(n === '1' && k(a)) && !c) {
        ...
        _z(t) {
          ...
          if (
            ...
            t && i
              ...
              : ((o = 'iti__flag iti__globe'), (a = n.noCountrySelected)),
              (this.l.className = o),
          ...
          if (r.utils && s) {
            let o = r.utils.numberType[e],
              a = this.s.iso2
                ...
                : '';
            (a = this._7(a)),
              typeof n == 'function' && (a = n(a, this.s)),
              this.a.setAttribute('placeholder', a);
          }
        }
        _1(t) {
